...
{
    public class PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTER : RecyclerView.Adapter
    {
        ...
        public PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTER(List<PRODUCT_PRICE_PROC_OUT> data)
        {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var vh = new PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTERViewHolder(itemView);
        ...
        public override async void OnBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
        {
            ...
            var holder = viewHolder as PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTERViewHolder;
    ...
    public class PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTERViewHolder : RecyclerView.ViewHolder
    {
        ...
        public PRODUCT_SALE_PRICE_SEARCH_RECYCLER_VIEW_ADAPTERViewHolder(View itemView) : base(itemView)
        {
